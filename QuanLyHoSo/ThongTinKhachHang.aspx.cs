...
public partial class QuanLyHoSo_ThongTinKhachHang : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                if (!check_permiss(user.UserID, FunctionName.ThongTinKhachHang))
                {
    ...
    private Boolean UpdateCustomerProfilePrivate()
    {
        ...
        bool hasUpdate = customerProPri.UpdateCustomerProfilePrivate(CusPri.ProfileID, txtCompanyCopyright.Text, Nationality, Ethnic, Religion, Country, Province, District, txtCommune_Ward.Text, txtPermanentAddress.Text, txtAddressPresent.Text, txtCompanyPhone.Text, txtHomePhone.Text, txtCellPhone.Text,txtEmail.Text,txtMaritalStatus.Text,txtTPXuatThan.Text,txtUuTienGD.Text,txtUuTienBanThan.Text,txtNangKhieu.Text,txtDisability.Text,txtHealthCondition.Text, Height, Weight, BloodID, DateOfBHXH,txtNumOfBHXH.Text,txtBank.Text,txtAccountNumber.Text, 1);
        return (hasUpdate)? true: false;
        //Response.Write("<script>alert(' "+ CusPri.ProfileID.ToString() + " !')</script>");
        //Response.Write("<script>alert('" +
        //    "  ___Copyright:" + Copyright.ToString() +
        //    "  ___Quốc tịch :" + Nationality +
        //    "  ___Dân tộc :" + Ethnic +
        //    "  ___Tôn giáo :" + Religion +
        //    "  ___Quốc Gia :" + Country +
        //    "  ___Tỉnh / Thành :" + Province +
        //    "  ___Quận / Huyện :" + District +
        //    "  ___Height :" + Height +
        //    "  ___Weight :" + Weight +
        //    "  ___BloodID :" + BloodID +
        //    "  ___Commune_Ward :" + Commune_Ward +
        //    "  ___PermanentAddress :" + PermanentAddress +
        //    "  ___AddressPresent :" + AddressPresent +
        //    "  ___CompanyPhone :" + CompanyPhone +
        //    "  ___HomePhone :" + HomePhone +
        //    "  ___CellPhone :" + CellPhone +
        //    "  ___Email :" + Email +
        //    "  ___MaritalStatus ;" + MaritalStatus +
        //    "  ___TPXuatThan :" + TPXuatThan +
        //    "  ___UuTienGD :" + UuTienGD +
        //    "  ___UuTienBanThan :" + UuTienBanThan +
        //    "  ___NangKhieu :" + NangKhieu +
        //    "  ___Disability :" + Disability +
        //    "  ___HealthCondition :" + HealthCondition +
        //    "___DateOfBHXH : "+ DateOfBHXH.ToString()+
        //    "  ___NumOfBHXH :" + NumOfBHXH +
        //    "  ___Bank :" + Bank +
    ...
    private Boolean NewThongTinPhuHuynh()
    {
        ...
        bool HasNewThongTin = thongtinphuhuynh.NewThongTinPhuHuynh(bsInfo.InfoID, fname_Dad, lname_Dad, NgSinh_Dad, noisinh_Dad, socmnd_Dad, noicap_Dad, NgayCap_Dad, sodienthoai_Dad, fname_Mom, lname_Mom, NgSinh_Mom, noisinh_Mom, socmnd_Mom, noicap_Mom, NgayCap_Mom, sodienthoai_Mom);
    ...
    protected void btnSavePrivateProfile_Click(object sender, EventArgs e)
    {
        try
        {
            if (!UpdateCustomerBasicInfo() || !UpdateCustomerProfilePrivate() || !NewThongTinPhuHuynh() || !NewCustomerProfileMoreInfor() || !NewCustomerProfileTypeInfor())
            {
