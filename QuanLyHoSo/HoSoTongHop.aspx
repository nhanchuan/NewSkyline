<%@ Page Title="" Language="C#" MasterPageFile="~/GlobalMasterPage.master" AutoEventWireup="true" CodeFile="HoSoTongHop.aspx.cs" Inherits="QuanLyHoSo_HoSoTongHop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!-- BEGIN PAGE HEADER-->
    <h1 class="page-title">Tổng Hợp Hồ Sơ Khách Hàng <small>CUSTOMER FILE INFORMATION</small>
    </h1>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="../QuanLyHoSo/HoSoTongHop.aspx">Tổng Hợp Hồ Sơ</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <a class="btn btn-primary" href="../QuanLyHoSo/KiemTraHoSoChuyen.aspx">Kiểm tra hồ sơ chuyển</a>
        </div>
        <hr />
                ...
                <ContentTemplate>
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>Danh sách hồ sơ chờ xử lý
                            </div>
                            <div class="tools">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button id="btnSendProfile" class="btn btn-warning" type="button" onserverclick="btnSendProfile_ServerClick" runat="server"><i class="fa fa-send"></i> Chuyển Hồ Sơ</button>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Làm Hồ Sơ">
                                        <ItemTemplate>
                                            ...
                                            <%--<i class="list-group-item bg-info"></i>--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
