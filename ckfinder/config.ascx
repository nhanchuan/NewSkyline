...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        DAL.UserAccounts use = Session.GetCurrentUser();
        bool IsAuthorized = (use == null) ? false : true;
        return IsAuthorized;
        //return true;
    }
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "Oliver";
        LicenseKey = "F6H4T1BYTFFUWYEJ1V8A5R5GSGGN9DLX";

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = "/images/Upload/ImagesInPost/";
