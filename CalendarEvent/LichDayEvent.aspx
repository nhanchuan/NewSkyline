<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LichDayEvent.aspx.cs" Inherits="CalendarEvent_LichDayEvent" %>
...
<head runat="server">
    ...
    <script src="../scripts/calendarLichDayScript.js" type="text/javascript" charset="UTF-8"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>Lịch Giảng GV :
            <asp:Label ID="lblGiaoVien" runat="server" Text="Label"></asp:Label></h1>
        <div id="calendar">
        </div>
