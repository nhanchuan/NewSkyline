<%@ WebHandler Language="C#" Class="JsonResponseLichHoc" %>
...
public class JsonResponseLichHoc : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        foreach (LichHocEvent cevent in viewlichhoc.getLichHocEvents(start, end, Convert.ToInt32(context.Session.GetCurrentCoSoID())))
        {
