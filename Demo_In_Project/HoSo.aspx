...
<%@ Page Title="" Language="C#" MasterPageFile="~/GlobalMasterPage.master" AutoEventWireup="true" CodeFile="HoSo.aspx.cs" Inherits="Demo_In_Project_HoSo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <!-- BEGIN PAGE HEADER-->
    <h1 class="page-title">Thông Tin Hồ Sơ <small>Category</small>
    </h1>
    <div class="page-bar">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="TextBox14" CssClass="form-control" Text="Công Ty Cổ Phân Đỉnh Cao Châu Mỹ ®" ReadOnly="true" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <%-- End row 1 --%>
                            <%-- Start row 2 --%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="dl" CssClass="form-control" runat="server"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <%-- End row 7 --%>
