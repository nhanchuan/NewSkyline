...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <link href="../App_Themes/admin/postnew.css" rel="stylesheet" />
        <!-- BEGIN PAGE HEADER-->
    <h1 class="page-title">Bài Viết Mới<small>New Post</small>
    </h1>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="../Pages/Post-New.aspx">Thêm bài viết</a>
            </li>
        </ul>
                                ...
                                <div id="DatetimePost" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br />
                                            <asp:Button ID="btnUpdateTimePost" CssClass="btn green pull-right" ValidationGroup="validtimepost" runat="server" OnClick="btnUpdateTimePost_Click" Text="Update Time" />
                                        </div>
                                    </div>
                                </div>
                                <%-- End Datetime picker --%>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse_3_3" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <br />
                            <asp:Button ID="btnAddTags" CssClass="btn btn-success pull-right" ValidationGroup="validTags" OnClick="btnAddTags_ServerClick" runat="server" Text="Thêm Tags" />
                            <br />
                            <br />
